      ...
      >
        <Row>
          <Col span={24}>
            <Input
              size='large'
              placeholder={firstNavTypeName}
              className='input input_title'
              onChange={(e) => setFirstNavTypeName(e.target.value)}
            />
          </Col>
          <Col span={24}>
            <Input
              ...
              placeholder={
                firstNavIcon
                  ? firstNavIcon
                  : 'icon图标(请在ant design中的icon组件中查找您所想要的图标)'
              }
              onChange={(e) => setFirstNavIcon(e.target.value)}
          ...
          <Col span={24}>
            {navId === 0 ? (
              <DatePicker
                defaultValue={moment(firstNavAddTime)}
                size='large'
              ...
              <DatePicker
                defaultValue={moment(firstNavEditTime)}
                size='large'
                format='YYYY-MM-DD HH:mm:ss'
                showTime
                placeholder='请选择修改时间'
      ...
      >
        <Row>
          <Col span={24}>
            <Input
              size='large'
              placeholder={secondNavTitle}
              className='input input_title'
              onChange={(e) => setSecondNavTitle(e.target.value)}
            />
          </Col>
            ...
            <List.Item>
              <Row className='list-div'>
                ...
                <Col span={6}>
                  <Button
                    type='danger'
                    onClick={() => deleteSecondNav(item.id)}
                    size='default'
                  >
                    删除
                  </Button>
