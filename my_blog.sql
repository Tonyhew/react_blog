...
-- ----------------------------
INSERT INTO `admin_user` VALUES (1, 'tonyhew', 'b2d31eb2ae9c528904ccf1788402b34d', 10, -1);
INSERT INTO `admin_user` VALUES (2, 'test', 'b2d31eb2ae9c528904ccf1788402b34d', 6, -1);
...
-- ----------------------------
INSERT INTO `blog_arctype` VALUES (1, '博客', 1, 'youtube', -1, NULL, '2020-06-05 17:14:48');
INSERT INTO `blog_arctype` VALUES (4, '1', 2, 'ie', -1, NULL, '2020-05-29 15:19:42');
INSERT INTO `blog_arctype` VALUES (6, 'ddd', 0, 'apple', -1, '2020-05-28 16:44:15', '2020-05-29 14:09:00');
...
CREATE TABLE `blog_secondnav`  (
  ...
  `add_time` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1069 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `blog_type` VALUES (1, '视频教程', 1, 'youtube');
INSERT INTO `blog_type` VALUES (2, '生活', 2, 'smile');
INSERT INTO `blog_type` VALUES (3, '大胖逼逼叨', 3, 'message');
