...
INSERT INTO `admin_user` VALUES (1,'tonyhew','123456');
...
INSERT INTO `blog_arctype` VALUES (1,'博客',1,'youtube',1),(4,'hhh',2,'youtube',-1);
...
INSERT INTO `blog_secondnav` VALUES (1001,1,'3',NULL),(1002,1,'dddd',NULL),(1003,1,'dsfs',NULL);
...
#
# Structure for table "nav_article"
#

DROP TABLE IF EXISTS `nav_article`;
CREATE TABLE `nav_article` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `nav_id` int(3) DEFAULT NULL,
  `article_id` int(1) DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4;

#
# Data for table "nav_article"
#

/*!40000 ALTER TABLE `nav_article` DISABLE KEYS */;
INSERT INTO `nav_article` VALUES (1,1001,1),(2,1001,2);
/*!40000 ALTER TABLE `nav_article` ENABLE KEYS */;
